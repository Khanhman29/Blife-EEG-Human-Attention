...
class ETReceive():
    ...
    def __init__(self):
        ...
        self.saving = False
        self.buffer_size=1
        self.sampling_len=len(self.lSample)
        ...
        try:
            ...
            if timestamps is not None:
                ...
                if x != 'none':
                    ...
                    x, y = -1, -1
                formatted = [timestamps, x, y]
                self.lastSample = formatted            
                if self.saving:
                    self.lSample.append(formatted)
            if self.sampling_len > self.buffer_size:
                self.lSample= np.delete(self.lastSample, 0, axis=1)
